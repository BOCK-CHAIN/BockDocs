        ...
        <div className="flex items-center gap-4">
          ...
          {user ? (
            <div className="relative group">
              ...
              <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 rounded-lg shadow-lg z-10 border border-gray-200 dark:border-gray-700 hidden group-hover:block">
                <div className="py-1">
